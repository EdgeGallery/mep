...
const (
	...
	// ak and sk is base64 string generated by mecm
	akRegex                string = `^[\w+/=]{20}$`
	skRegex                string = `^[\w+/=]{64}$`
...
const (
	MepserverRateConf               = `{ "minute": 12000, "policy": "local", "hide_client_headers": true }`
	MepserverPreFunctionConf        = `{ "functions": ["ngx.var.upstream_x_forwarded_for=UNKNOWN"] }`
	MepauthRateConf                 = `{ "minute": 1200, "policy": "local", "hide_client_headers": true }`
